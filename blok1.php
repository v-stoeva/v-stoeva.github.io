...
if(isset($_SESSION['logedblok1']) AND $_SESSION['logedblok1'] ){
    
}else {
    header('Location:login.php');
}
if(isset($_GET['logout'])){
    $_SESSION['logedblok1']=FALSE;
    header('Location:login.php');
...
$servername = "localhost";
            ...
            $sql = "SELECT apartnum, olddutys , months.monthname, lastpayment FROM blok1 LEFT JOIN months on month=m_id";
            $query = mysqli_query($conn,$sql);
            ...
            $sql = "SELECT  monthname, availability , monthlyduties, restformonth FROM blok1view LEFT JOIN months ON id=m_id";
            $query = mysqli_query($conn,$sql);
            ...
            $sql = "SELECT  monthname, name , sum, picture FROM blok1files LEFT JOIN months ON month=m_id";
            $query = mysqli_query($conn,$sql);
						...
						<div class="row">
							...
							<div class="col-xs-10 text-right menu-1 main-nav" style="font-size: 40px;">
								<ul>
									...
									<li class="btn-cta"><a href="blok1.php?logout=" class="external"><span>Изход</span></a></li>
		...
		<div class="container">
			<div class="row row-pb-md">
				<div class="col-md-8 col-md-offset-2 heading animate-box" data-animate-effect="fadeIn">
					...
					<p class="sub" style="color:red;"><?php print_r($_SESSION)?></p>
				</div>
			</div>
			<div class="row">
				<!-- <div class="col-md-8"> -->
